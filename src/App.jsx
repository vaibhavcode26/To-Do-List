...
function App() {
  ...
  const togglecmplt = (id) =>{
    setTodos ((prev) => prev.map((eachtodo) => eachtodo.id === id ? {completed : !eachtodo.completed} : eachtodo))
  }
  ...
  return (
    <TodoProvider value={{addTodo , deleteTodo , updateTodo , togglecmplt , todos}}>
